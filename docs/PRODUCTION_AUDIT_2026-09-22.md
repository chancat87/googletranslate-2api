...
| 压测 | 极限缓存命中 conc 1000 | 1000/1000 200，0 错 0 429，QPS 32.2，p50 18.1s |
| 压测 | 极限真实上游 conc 1000 | 1000/1000 200，0 错 0 429，QPS 16.8，p50 38.3s |
...
- 极限压测：conc 1000 全 200 0 错 0 429；单机真实上限 16.8 QPS（上游）/ 32.2 QPS（缓存），1000 QPS 需多 Key + 多副本 + 付费代理
